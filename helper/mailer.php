...
{
$this->SMTPDebug  = Config::$SMTPDebug;       // enables SMTP debug information (for testing)
...
$this->SMTPSecure= Config::$SMTPSecure;					//type
$this->Username   = Config::$smtpUsername; // SMTP account username
$this->Password   = Config::$smtpPassword;        // SMTP account password
if(Config::$usesmtp){
    $this->Mailer = 'smtp';
}  else {
    $this->isMail();
